...
public class MainProject {
	...
	public static void main(String[] args) {
		...
		// ORA FARÓ SI CHE SIA L'UTENTE A SCEGLIERE, TRAMITE LO SCANNER, I VARI ELEMENTI MULTIMEDIALI
        		   ...
        		   if(lettoreMultimediale[inputLettoreMultimediale - 1] instanceof Immagine) {
                       ...
                       switch (risposta1) {
                           ...
                           switch (risposta1) {
							...
							System.out.println(
									"Vuoi modificare il volume o la luminosità? \n1. Il volume \n2. La luminositá");
							...
							case 1:
								...
								//la luminositá
								case 2:
									System.out.println("Vuoi modificare la luminositá? \n1. Si \n2. No, va bene così");
									int risposta2a = Integer.parseInt(input.nextLine());
									switch (risposta2a) {
									case 1:
										System.out.println(
												"Vuoi abbassare o alzare la luminositá? \n1. Abbassare la luminositá. \n2. Alzare la luminositá.");
										int risposta1b = Integer.parseInt(input.nextLine());
